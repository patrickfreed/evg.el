...
* TODO test results [2/5]
  - [X] show test results in task results buffer
  - [ ] add button for viewing task logs
  - [X] view individual test result
  - [ ] define major mode for test results file
  - [ ] add key binding for going back to task from test buffer

* TODO task/patch reconfiguration [0/6]
  - [ ] configure "created" patches
  - [ ] abort tasks
  - [ ] abort patches
  - [ ] reconfigure patches
  - [ ] restart patches
...
* TODO prepare repository for release
